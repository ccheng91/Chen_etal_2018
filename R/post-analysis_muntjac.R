#post-analysis muntjac 
rm(list=ls(all=TRUE))
load("~/Desktop/data/Chen_etal_2018/Workplace/RN_model_park_eff_muntjac.RData")
...
write.csv(cater, file = "Result/beta_conf_villagereport_muntjac.csv")
...
write.csv(cater, file = "Result/beta_conf_parkreport_muntjac.csv")
