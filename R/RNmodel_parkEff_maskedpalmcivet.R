...
## read stuff ##
rm(list=ls(all=TRUE))
dec.data<-read.csv("data/final/dec.data.maskedpalmcivet.csv",header=TRUE, row.names=1)
...
save.image("~/Desktop/data/Chen_etal_2018/Workplace/RN_model_park_eff_maskedpalmcivet.RData")
...
##### beta conf plot ############ beta conf table #########
